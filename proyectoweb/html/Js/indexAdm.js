class Buscador
{
    ...
    {
        var retorno = html + "<tr>\n";
        const COLUMNAS = ["Nombre","Apellido","DNI","Matricula","Usuario(Email)"];
        for(let i = 0;i<5;i++)
...
arrayArtificial = [["dasdas","asdasdsada","sdasdasdas","dasdaa","asddasdas"],["Coca cola","afil","pacien","das","zvb"],["Tercera","das","nb","fa","dasd"]];
